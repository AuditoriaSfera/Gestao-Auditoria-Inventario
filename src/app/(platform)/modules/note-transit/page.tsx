      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap' }}>
        <div>
          ...
          <p style={{ fontSize: '14px', color: '#64748b', margin: 0 }}>
            Importação e acompanhamento de notas fiscais em trânsito — Indústria (7 dias) e Transferências (4 dias)
          </p>
        </div>
        {notes && (
          <button
          ...
          {loading ? (
            ...
            <>
              ...
              <p style={{ fontSize: '12px', color: '#94a3b8', margin: '16px 0 0' }}>
                Filtros aplicados automaticamente: Compras Cálamo · Transferências · Pendente · Pendente de Entrega · Inconsistente
              </p>
            </>
          )}
        </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
                  <thead>
                    <tr style={{ background: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
                      {[
                        'Atraso', 'Prev. Entrega', 'Lead', 'Tipo',
                        'Cód. Loja', 'Cód. Fornecedor', 'Nome do Fornecedor',
                        'Data Emissão', 'Valor Total', 'Situação',
                      ].map(h => (
                        <th key={h} style={{
                      ...
                      return (
                        <tr
                          ...
                          style={{
                            ...
                            background: n.diasAtraso > 0 ? '#fff9f9' : 'white',
                          }}
